...
namespace Prakt2 {
    ...
    public partial class KostyaDataSet1 : global::System.Data.DataSet {
        ...
        public partial class booksDataTable : global::System.Data.TypedTableBase<booksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public booksRow AddbooksRow(string theme, string author, string name, string publisher, System.DateTime year) {
        ...
        public partial class booksRow : global::System.Data.DataRow {
            ...
            public string theme {
                get {
                    return ((string)(this[this.tablebooks.themeColumn]));
                }
                set {
                    this[this.tablebooks.themeColumn] = value;
                }
            }
...
namespace Prakt2.KostyaDataSet1TableAdapters {
    ...
    public partial class booksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `books` WHERE ((`id` = @p1) AND (`theme` = @p2) AND (`author` = @p3) " +
                "AND (`name` = @p4) AND (`publisher` = @p5) AND (`year` = @p6))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `books` (`theme`, `author`, `name`, `publisher`, `year`) VALUES (@p1," +
                " @p2, @p3, @p4, @p5)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `books` SET `theme` = @p1, `author` = @p2, `name` = @p3, `publisher` = @p4" +
                ", `year` = @p5 WHERE ((`id` = @p6) AND (`theme` = @p7) AND (`author` = @p8) AND " +
                "(`name` = @p9) AND (`publisher` = @p10) AND (`year` = @p11))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Prakt2.Properties.Settings.Default.KostyaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `id`, `theme`, `author`, `name`, `publisher`, `year` FROM `books`";
        ...
        public virtual int Fill(KostyaDataSet1.booksDataTable dataTable) {
        ...
        public virtual KostyaDataSet1.booksDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            KostyaDataSet1.booksDataTable dataTable = new KostyaDataSet1.booksDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(KostyaDataSet1.booksDataTable dataTable) {
